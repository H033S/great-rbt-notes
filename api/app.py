...
async def generate_test_report(payload: FrontendReportData):
    """
    Generates a test report by reading a static file.
    Accepts data structured according to the `FrontendReportData` model.
    ...
    try:
        ...
        return Response(content=dummy_report, media_type="text/plain") # Test returning JSON
